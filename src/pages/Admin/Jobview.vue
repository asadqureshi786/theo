...
export default {
  ...
  try {
    ...
    const response = await axios.get(
      this.$baseURL + `theo/api/admin/requests/${id}`,
      {
        headers: {
    ...
    async fetchSquadPlayer() {
      try {
        const response = await axios.get(
          this.$baseURL + "theo/api/admin/squad-players/all-players",
          {
            headers: {
              Accept: "application/json",
              Authorization: `Bearer ${this.token}`,
    ...
    async sendPropose() {
      ...
      try {
        const response = await axios.post(
          this.$baseURL + "theo/api/admin/requests/propose",{request_id: this.request.id,player_id: this.selectedCity.id},
          {
            headers: {
              Accept: "application/json",
              Authorization: `Bearer ${this.token}`,
