...
<script>
import Playercard from "@/components/agents/Playercard.vue";
...
export default {
  ...
  methods : {
    async fetchPlayers(){
          try {
        const response = await axios.get(this.$baseURL+`theo/api/agent/players`, {
          headers: {
