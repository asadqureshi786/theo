  ...
  data(){
    ...
    methods: {
         ...
         async updateGeneral(){
          ...
          if (this.selectedFile == null) {
            ...
            formData.append("profile", this.selectedFile);
             ...
             try {
              const response = await axios.post(this.$baseURL+"theo/api/agent/settings/update-profile",formData,{
                  headers: {
                    'Accept' : 'application/json',
        ...
        async updatePassword(){
          try{
            const response = await axios.post(this.$baseURL+`theo/api/agent/settings/change-password`,this.security,{
                  headers: {
                  'Accept' : 'application/json',
                  Authorization: `Bearer ${this.token}`, 
                },
